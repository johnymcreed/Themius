...
function init ()
{
    ...
    document.addEventListener("DOMContentLoaded", function(event) 
    {
        ...
        fXMLReadData('feed/custom.txt', '[feed="custom"]', 'custom');
        fXMLReadData('feed/backends.txt', '[feed="backends"]', 'backends');
        ...
        // Content loads to fast for this to register
        setTimeout(() => {  
...
function fXMLReadData (file, Element, Direct)
{
    ...
    let link = document.querySelector('article');
    if (link) 
    {
