			...
			if (item.hasAttribute('disabled')) {
				...
				try {
					document.querySelector('.submit-disabled').innerHTML =
						'This was set as <b>unsubmittable</b> so we went ahead and re-opened it for you. (note that due to how this websites code works you cannot use the toolbar features)';
				} catch (err) {}
			}
		}
	}
